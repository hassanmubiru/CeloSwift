...
class UnifiedMetaMaskService extends EventEmitter {
  private static instance: UnifiedMetaMaskService;
  private connection: ConnectionStatus = {
    connected: false,
  };

  private readonly STORAGE_KEYS = {
    CONNECTION_DATA: 'unified_metamask_connection',
  };

  public static getInstance(): UnifiedMetaMaskService {
    if (!UnifiedMetaMaskService.instance) {
      UnifiedMetaMaskService.instance = new UnifiedMetaMaskService();
    }
    return UnifiedMetaMaskService.instance;
  }

  // Initialize the service
  async initialize(): Promise<boolean> {
    try {
      console.log('UnifiedMetaMaskService: Initializing...');
      await this.loadConnectionData();
      console.log('UnifiedMetaMaskService: Initialization completed');
      return true;
    } catch (error) {
      console.error('UnifiedMetaMaskService: Initialization failed:', error);
      return false;
    }
  }
  ...
  async connect(): Promise<boolean> {
    try {
      console.log('UnifiedMetaMaskService: Starting connection...');
      ...
      console.error('UnifiedMetaMaskService: Connection error:', error);
  ...
  private async connectWeb(): Promise<boolean> {
    try {
      ...
      console.log('UnifiedMetaMaskService: MetaMask detected, requesting accounts...');
      ...
      console.log('UnifiedMetaMaskService: Accounts received:', accounts);
      ...
      console.log('UnifiedMetaMaskService: Web connection successful:', address);
      ...
      console.error('UnifiedMetaMaskService: Web connection error:', error);
  ...
  private async connectWithAddress(address: string | undefined, resolve: (value: boolean) => void): Promise<void> {
    try {
      ...
      console.log('UnifiedMetaMaskService: Connecting with address:', address);
      ...
      console.log('UnifiedMetaMaskService: Mobile connection successful:', address);
      ...
      console.error('UnifiedMetaMaskService: Error connecting with address:', error);
  ...
  private async ensureCeloNetwork(ethereum: any): Promise<void> {
    try {
      ...
      if (chainId !== celoChainId) {
        console.log('UnifiedMetaMaskService: Switching to Celo Alfajores network...');
      ...
      console.error('UnifiedMetaMaskService: Network switching error:', error);
  ...
  private handleError(message: string, error: any): void {
    console.error(`UnifiedMetaMaskService: ${message}:`, error);
  ...
  async disconnect(): Promise<void> {
    try {
      ...
      console.log('UnifiedMetaMaskService: Disconnected successfully');
    } catch (error) {
      console.error('UnifiedMetaMaskService: Disconnect error:', error);
    }
  }
  ...
  private async saveConnectionData(): Promise<void> {
    try {
      ...
      console.error('UnifiedMetaMaskService: Save connection data error:', error);
    }
  }
  ...
  private async loadConnectionData(): Promise<void> {
    try {
      ...
      console.error('UnifiedMetaMaskService: Load connection data error:', error);
    }
  }
  ...
  private async clearConnectionData(): Promise<void> {
    try {
      ...
      console.error('UnifiedMetaMaskService: Clear connection data error:', error);
    }
  }
  ...
  async updateBalance(): Promise<void> {
    try {
      ...
      console.error('UnifiedMetaMaskService: Update balance error:', error);
    }
  }
}

export default UnifiedMetaMaskService.getInstance();
